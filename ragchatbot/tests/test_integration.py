...
class TestGraphRAGIntegration:
    ...
    def test_entity_extraction_and_graph_construction(self):
        ...
        # Test entity types
        tech_entities = [e for e in graph_store.entities.values() 
    ...
    def test_multi_course_graph_construction(self):
        ...
        python_entities = [e for e in graph_store.entities.values() 
    ...
    def test_graph_relationship_discovery(self):
        ...
        if python_entities:
            ...
            related_entities = graph_store.get_related_entities(python_entity.id, max_depth=2)
