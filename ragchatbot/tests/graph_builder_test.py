...
class TestGraphBuilder:
    ...
    def test_build_graph_from_chunks(self, ai_course_chunks):
        ...
        lesson_entities = [
            e
            for e in graph_store.entities.values()
            if e.entity_type == EntityType.LESSON
        ]
    ...
    def test_update_graph_with_new_chunks(self, ai_course_chunks):
        ...
        updated_graph = self.builder.update_graph_with_new_chunks(
            new_chunks, initial_graph
        )
    ...
    def test_update_graph_with_overlapping_entities(self):
        ...
        # Find Python entity
        python_entities = [
            e for e in initial_graph.entities.values() if "python" in e.name.lower()
        ]
    ...
    def test_get_graph_summary(self, ai_course_chunks):
        ...
        self.builder.build_graph_from_chunks(ai_course_chunks)
    ...
    def test_find_chunks_by_entity_name(self, ai_course_chunks):
        ...
        non_existent_chunks = self.builder.find_chunks_by_entity_name(
            "NonExistentEntity"
        )
    ...
    def test_find_chunks_by_entity_name_with_type(self, ai_course_chunks):
        ...
        tech_chunks = self.builder.find_chunks_by_entity_name(
            "Python", EntityType.TECHNOLOGY
        )
        course_chunks = self.builder.find_chunks_by_entity_name(
            "AI Course", EntityType.COURSE
        )
    ...
    def test_get_entity_connections(self, ai_course_chunks):
        ...
        non_existent_connections = self.builder.get_entity_connections(
            "NonExistentEntity"
        )
